...
class Room:
    ...
    def link_room(self, another_room: 'Room', side: str) -> None:
        """this function add a new key(side of the world) and value(room) to the dictionary"""
        self.sides_of_the_world[side] = another_room
